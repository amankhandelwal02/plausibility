...
const Footer = () => {
  return (
    <div className='px-7 md:px-20 py-10 md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-20 items-center space-y-10 md:space-y-0 lg:space-y-0 lg:flex'>
