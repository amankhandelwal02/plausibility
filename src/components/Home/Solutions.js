...
const Solutions = () => {
  return (
    <div className="p-10 bg-[#F3F7FF] space-y-10">
      <div className="flex flex-col md:items-center md:text-center space-y-4 md:space-y-2 lg:items-center justify-center">
...
<p className="text-base text-gray-500">No more wasted resources. No more runaway budgets. No more excuses.</p>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10 px-0 sm:px-16 md:px-16 lg:px-28'>
